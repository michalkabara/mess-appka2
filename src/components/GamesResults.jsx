      ...
      <div className="mecze py-3 px-6 text-sm">
        <table className="w-full border-spacing-y-3 border-separate">
          <tbody>
            {data.map((mecz, index) => (
              <tr
                key={`${mecz.Team1}-${index}`}
                className=" rounded-lg border-spacing-4"
              >
                <td className="w-[100px] text-left">15:00</td>
                <td className="text-left">
                  <Link to={`/team/${mecz.Team1}`}>
                    {" "}
                    <div className="flex flex-row items-center gap-2">
                      <img src={mecz.Team1Logo} className="w-auto h-5" />
                      {mecz.Team1}
                    </div>
                  </Link>
                  ...
                  <Link to={`/team/${mecz.Team2}`}>
                    <div className="mt-2 flex flex-row items-center gap-2">
                      <img className="w-auto h-5" src={mecz.Team2Logo} />
                      {mecz.Team2}
                    </div>
                  </Link>
                </td>
