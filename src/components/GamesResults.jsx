  ...
  return (
    <>
        <div className='league-name py-4'>
            ...
            <div className='mecze py-3 px-6'>
            <table className='w-full'>

                {gameResults.map((mecz,index) => 

                        <tr key={`${mecz.Team1}-${index}`}>
                            ...
                            <td className="text-left">
                                ...
                                <div class="flex flex-row items-center gap-2"><img className="w-auto h-5" src={mecz.Team2Logo}/>{mecz.Team2}</div></Link>
